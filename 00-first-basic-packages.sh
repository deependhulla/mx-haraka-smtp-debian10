...
apt-get -y install spamassassin clamav-daemon clamav-freshclam rspamd redis-server dnsutils certbot
apt-get -y install traceroute iputils-tracepath sudo libmailtools-perl 
